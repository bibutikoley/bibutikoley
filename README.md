...
| [mcps-marketplace](https://github.com/bibutikoley/mcps-marketplace) · [live ↗](https://bibutikoley.github.io/mcps-marketplace/) | MCP plugin marketplace for AI coding agents: mobile device automation (Android + iOS) and Apple Notes | **Python** |
